...
#define ROWS 10
#define COLUMNS 10
#define DOT_LAT_SPACING 70
#define DOT_VERT_SPACING 70
#define CELL_LAT_SPACING 200
#define CELL_VERT_SPACING 300
...
char dot1[50]={'A','B','C','D','E','F','G','H','K','L','M','N','O','P','Q','R','U','V','X','Y','Z','1','2','3','4','5','6','7','8','<','a'};
char dot2[50]={'C','D','F','G','I','J','M','N','P','Q','S','T','W','X','Y','3','4','6','7','9','0','/','@','#','>','a','n'};
char dot3[50]={'B','F','G','H','I','J','L','P','Q','R','S','T','V','W','2','6','7','8','9','0','.',',',';',':','?','!','+','-','"','<','(',')','a'};
char dot4[50]={'D','E','G','H','J','N','O','Q','R','T','W','Y','Z','4','5','7','8','0','.',':','!','@','#','+','-','*','>','(',')','n'};
char dot5[50]={'K','L','M','N','O','P','Q','R','S','T','U','V','X','Y','Z',';','/','?','!','@','#','+','*','"',39,'>','(',')','_','a','n'};
char dot6[50]={'U','V','W','X','Y','Z','.','?','#','"','<','(',')','u','_','a','n'};


char input[100];
char output[100];
void get_input();
void gen_cell(int row, int col, char character);
int in(char character, int dot);
...
int main(){
  ...
  int col;
  int pos=0;
  /*printf("length dot3: %lu\n",strlen(dot5));
  for(i=0;i<strlen(dot5);i++){
    printf("%c\n",dot5[i]);
  }*/
  ...
  for(row=0;row<ROWS;row++){    //ROWS
    for(col=0;col<COLUMNS;col++){  //COLUMNS
      if(output[pos]=='\0'){
        break;
      }
      gen_cell(row, col, output[pos]);
      pos++;
    }
    if(output[pos]=='\0'){
      break;
...
void gen_cell(int row, int col, char character){
  ...
  if(in(character,1)){      //dot 1
    ...
    for(i=0;i<125;i++){
      ...
      printf("outer loop\n");
      printf("vertex ");
      printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING,z_vertex[vertex]);
      vertex++;
      printf("vertex ");
      printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING,z_vertex[vertex]);
      vertex++;
  ...
  if(in(character,2)){      //dot 2
    ...
    for(i=0;i<125;i++){
      ...
      printf("outer loop\n");
      printf("vertex ");
      printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING+DOT_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING,z_vertex[vertex]);
      vertex++;
      printf("vertex ");
      printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING+DOT_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING,z_vertex[vertex]);
      vertex++;
  ...
  if(in(character,3)){      //dot 3
    ...
    for(i=0;i<125;i++){
      ...
      printf("outer loop\n");
      printf("vertex ");
      printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING+DOT_VERT_SPACING,z_vertex[vertex]);
      vertex++;
      printf("vertex ");
      printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING+DOT_VERT_SPACING,z_vertex[vertex]);
      vertex++;
    ...
    if(in(character,4)){      //dot 4
      ...
      for(i=0;i<125;i++){
        ...
        printf("outer loop\n");
        printf("vertex ");
        printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING+DOT_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING+DOT_VERT_SPACING,z_vertex[vertex]);
        vertex++;
        printf("vertex ");
        printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING+DOT_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING+DOT_VERT_SPACING,z_vertex[vertex]);
        vertex++;
    ...
    if(in(character,5)){      //dot 5
      ...
      for(i=0;i<125;i++){
        ...
        printf("outer loop\n");
        printf("vertex ");
        printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING+2*DOT_VERT_SPACING,z_vertex[vertex]);
        vertex++;
        printf("vertex ");
        printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING+2*DOT_VERT_SPACING,z_vertex[vertex]);
        vertex++;
    ...
    if(in(character,6)){      //dot 6
      ...
      for(i=0;i<125;i++){
        ...
        printf("outer loop\n");
        printf("vertex ");
        printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING+DOT_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING+2*DOT_VERT_SPACING,z_vertex[vertex]);
        vertex++;
        printf("vertex ");
        printf("%lf %lf %lf\n",x_vertex[vertex]+col*CELL_LAT_SPACING+DOT_LAT_SPACING,y_vertex[vertex]+row*CELL_VERT_SPACING+2*DOT_VERT_SPACING,z_vertex[vertex]);
        vertex++;
